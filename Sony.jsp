...
<body class="sony">
	...
	<div id="contain">
		...
		<section id="desc">
		<img class = "img-disp" alt="Play Station" src="Images/Ps.jpg" height="200px" width="100%">
			...
			BasicDBObject bdbo1 = new BasicDBObject();
									bdbo1.append("field0", "PS3")
											...
											.append("field6", "20")
											.append("field7", "10")
											.append("field8", "Ps3.jpg")
											.append("field9",
													System.currentTimeMillis());
									BasicDBObject bdbo2 = new BasicDBObject();
									bdbo2.append("field0", "PS4")
											.append("field1", "650")
											.append("field2", "Sony")
											.append("field3", "Gaming Console")
											.append("field4", "New")
