	...
	<div id="contain">
		...
		<section id="desc">
			...
			<%
				...
				bdbo.put("field2", "Other");
				bdbo.put("field3", "Other");
			...
			BasicDBObject bdbo1 = new BasicDBObject();
									bdbo1.append("field0", "HP Laptop")
											...
											.append("field6", "50")
											.append("field7", "10")
											.append("field8", "Hp.jpg")
											.append("field9",
													System.currentTimeMillis());
									BasicDBObject bdbo2 = new BasicDBObject();
									bdbo2.append("field0", "Lenovo Laptop")
											.append("field1", "840")
											.append("field2", "Other")
											.append("field3", "Other")
											.append("field4", "New")
											...
											.append("field6", "20")
											.append("field7", "50")
											.append("field8", "Lenovo.jpg")
											.append("field9",
													System.currentTimeMillis());
									products.insert(bdbo1);
									products.insert(bdbo2);
									BasicDBObject bdb = new BasicDBObject();
									bdb.put("field2", "Other");
									bdb.put("field3", "Other");
